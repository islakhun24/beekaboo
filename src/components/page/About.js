...
const About = (props)=>{
  ...
  useEffect(()=>{
    ...
    return (
        <div className="p-8 w-screen overflow-hidden">
          <div className="lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 grid-cols-1 grid ">
          <div style={{fontFamily: 'Sniglet'}} className="col-span-2 text-white flex flex-col  items-center lg:px-20  xl:px-20  2xl:px-20 py-40 ">
